...
/*   Updated: 2024/10/26 14:44:29 by myuen            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	process_julia_args(t_data *data, const int argc, const char **argv)
{
	...
	if (argc != 4)
	{
		ft_printf("Using default Julia parameters.\n");
		data->c->real = -0.4;
		data->c->imag = 0.6;
		return (0);
	}
	...
	{
		ft_printf("Error: Julia parameters should be valid floats.\n");
		return (1);
	}
	...
	{
		ft_printf("Julia parameters should be floats between -2.0 and 2.0\n");
		return (1);
	}
	return (0);
}
		...
		const int argc, const char **argv)
{
	...
	{
		ft_printf("Invalid argument or fractal type.\n\tUse -m, -j, or -t.\n");
		return (1);
	}
	return (0);
}
